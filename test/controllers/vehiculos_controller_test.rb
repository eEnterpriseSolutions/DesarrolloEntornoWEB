...
class VehiculosControllerTest < ActionController::TestCase
  ...
  test "should create vehiculo" do
    assert_difference('Vehiculo.count') do
      post :create, vehiculo: { marca: @vehiculo.marca, modelo: @vehiculo.modelo, placa: @vehiculo.placa, tipo_vehiculo_id: @vehiculo.tipo_vehiculo_id }
    end
  ...
  test "should update vehiculo" do
    patch :update, id: @vehiculo, vehiculo: { marca: @vehiculo.marca, modelo: @vehiculo.modelo, placa: @vehiculo.placa, tipo_vehiculo_id: @vehiculo.tipo_vehiculo_id }
    assert_redirected_to vehiculo_path(assigns(:vehiculo))
  end
